...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class=""><a href="<?php echo base_url()."index.php/Crud/readData"; ?>"><svg class="glyph stroked table"><use xlink:href="#stroked-table"></use></svg> Edit Produk</a></li>
			<li class="active"><a href="<?php echo base_url()."index.php/Crud/readDataStyle"; ?>"><svg class="glyph stroked table"><use xlink:href="#stroked-table"></use></svg> Edit Style Rambut</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">List Gaya Rambut</h1>
			</div>
		</div><!--/.row-->
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="" data-show-toggle="" data-show-columns="" data-search="" data-select-item-name="" data-pagination="" data-sort-name="" data-sort-order="">
						    <thead>
						    <tr>
						        <th data-field="state" data-checkbox="" >Style ID</th>
						        <th data-field="namaProduk" data-sortable="true">Tipe Gaya</th>
						        <th data-field="hargaProduk"  data-sortable="true">Foto</th>
						        <th data-field="deskripsi" data-sortable="">Detail Gaya</th>
						        <th data-field="upload" data-sortable="">Harga</th>
						    ...
						    <tr>
						    	<td><?php echo $x['id']; ?></td>
							      ...
							      <td><img src="<?php echo base_url('uploadGaya/'.$x['foto']); ?>" height='40' width='40'> </td>
							      <td><?php echo $x['price']; ?></td>
							      <td><?php echo 'Rp'.number_format($x['price2'], 0, ',','.'); ?></td>
							      
							      <td><button><a href="<?php echo base_url()."index.php/Crud/getProdukStyle/".$x['id']; ?>">Edit</a> </button> </td>  
							      <td><button><a href="<?php echo base_url()."index.php/Crud/deleteStyle/".$x['id']; ?>"> Delete</a> </button> </td>
						    </tr>
						    <?php } ?>
						    </tbody>
						</table>
