...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Tambah Gaya Rambut</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
						...
						<form method="POST" action="<?php echo base_url()."index.php/Crud/addUploadStyle"?>" enctype="multipart/form-data">    
					    Deskripsi : <br><input type="text" name="deskripsi"><br>
					    Detail Gaya : <br><textarea type="text" name="price" rows="5" cols="30"></textarea><br>
					    Harga : <br><input type="text" name="price2"><br>
					    Upload Gambar : <br> <input type="file" name="uploadStyle"><br><br>
		...
		<br>
		<div class="col-md-12">
		<p style="text-align:center">All rights Reserved - Created By Maman</p>
		</div> <!--/.row-->
		<!--	
		<div class="row">
			<div class="col-md-6">
