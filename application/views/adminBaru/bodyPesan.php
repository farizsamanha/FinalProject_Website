...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="<?php echo base_url()."index.php/email"; ?>"><svg class="glyph stroked app-window"><use xlink:href="#stroked-app-window"></use></svg> Pesan Masuk</a></li>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="" data-show-toggle="" data-show-columns="" data-search="" data-select-item-name="" data-pagination="" data-sort-name="" data-sort-order="">
						    <thead>
						    <tr>
						        <th data-field="state" data-checkbox="" >ID PESAN</th>
						        <th data-field="namaProduk" data-sortable="true">Nama</th>
						        <th data-field="hargaProduk"  data-sortable="true">Email</th>
						        <th data-field="deskripsi" data-sortable="">Pesan</th>
						        <th data-field="upload" data-sortable="">Nomor HP</th>
						    ...
						    <tr>
						    	<td><?php echo $x['id']; ?></td>
							      ...
							      <td><?php echo $x['hp']; ?></td>
							      <td><button><a href="<?php echo base_url()."index.php/email/delete/".$x['id']; ?>"> Delete</a> </button> </td>
						    </tr>
						    <?php } ?>
						    </tbody>
						</table>
