		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					    ...
					    Deskripsi : <br><textarea type="text" name="deskripsi" rows="5" cols="30"></textarea><br>
					    Upload Gambar : <br> <input type="file" name="upload"><br>
					    <input type="submit" value="Tambahkan Produk">
					    <br><br>
					    <button type="submit"><a href="<?php echo base_url()."index.php/Crud/readData/" ?>"> Kembali </a></button>
