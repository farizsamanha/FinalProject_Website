...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Edit Gaya Rambut</h1>
			</div>
		</div><!--/.row-->
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" >Advanced Table</div>
						...
						<form method="POST" action="<?php echo base_url();?>index.php/Crud/updateStyle" enctype="multipart/form-data">
					      Id : <br><input type="text" name="id" value="<?php echo $id ?>" readonly="$id"><br>
					      Tipe Gaya : <br><input type="text"   name="deskripsi" value="<?php echo $deskripsi ?>"><br>
					      Detail Gaya : <br><input type="text"   name="price" value="<?php echo $price ?>"><br>
					      Harga : <br><input type="text"    name="price2" value="<?php echo $price2 ?>"><br>
					      Foto : <br><input type="file"     name="uploadStyle" value="<?php echo base_url('uploadGaya/ $foto') ?>">
					      <br>
					      <button type="submit">Update Gaya Rambut</button>
					    </form>
