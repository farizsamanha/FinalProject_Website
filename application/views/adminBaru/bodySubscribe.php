...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="<?php echo base_url()."index.php/Smtp/viewPage"; ?>"><svg class="glyph stroked app-window"><use xlink:href="#stroked-app-window"></use></svg> Subscriber</a></li>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="" data-show-toggle="" data-show-columns="" data-search="" data-select-item-name="" data-pagination="" data-sort-name="name" data-sort-order="">
						    <thead>
						    <tr>
						        <th data-field="state" data-checkbox="" >Subscribe ID</th>
						        <th data-field="namaSubscriber" data-sortable="true">Nama Subscriber</th>
						        <th data-field="Email"  data-sortable="true">Email</th>
						        <th data-field="delete"  data-sortable="true">Aksi Delete</th>

						        
						    </tr>						    
						    </thead>
						    <tbody>
						    <?php foreach($dataSubscribe as $x){ ?>
						    <tr>
						    	  <td><?php echo $x['id']; ?></td>
							      <td><?php echo $x['nama']; ?></td>
							      <td><?php echo $x['email']; ?></td>
							      <td><button><a href="<?php echo base_url()."index.php/Smtp/deleteSubs/".$x['id']; ?>"> Delete</a> </button> </td>
						    </tr>
						    <?php } ?>
						    </tbody>
						</table>
