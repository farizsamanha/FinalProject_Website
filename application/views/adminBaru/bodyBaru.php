...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			-->
			<li class="active"><a href="<?php echo base_url()."index.php/Crud/dashboard"; ?>"><svg class="glyph stroked table"><use xlink:href="#stroked-table"></use></svg> Dashborad</a></li>
			...
			<li class=""><a href="<?php echo base_url()."index.php/email/readEmail"; ?>"><svg class="glyph stroked app-window"><use xlink:href="#stroked-app-window"></use></svg> Pesan Masuk</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
					...
					<svg class="glyph stroked checkmark"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#stroked-checkmark"></use></svg> Selamat Datang  <?php echo $this->session->nama; ?>, Silahkan pilih Menu untuk melanjutkan <a href="#" class="pull-right"><span class="glyphicon glyphicon-remove"></span></a>
				</div>
